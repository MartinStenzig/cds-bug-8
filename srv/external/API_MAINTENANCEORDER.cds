/* checksum : 06c68176c428608da7d90eedddcb075f */
@cds.external : true
...
entity API_MAINTENANCEORDER.MaintenanceOrder {
  ...
  to_MaintenanceOrderLongText : Composition of many API_MAINTENANCEORDER.MaintenanceOrderLongText {  };
  to_MaintenanceOrderOperation : Composition of many API_MAINTENANCEORDER.MaintenanceOrderOperation {  };
  to_MaintenanceOrderPartner : Composition of many API_MAINTENANCEORDER.MaintenanceOrderPartner {  };
  to_MaintenanceOrderPhaseControl : Composition of many API_MAINTENANCEORDER.MaintenanceOrderPhaseControl {  };
  to_MaintOrderObjectListItem : Composition of many API_MAINTENANCEORDER.MaintOrderObjectListItem {  };
  to_MaintOrderSettlmtDistrRule : Composition of many API_MAINTENANCEORDER.MaintOrderSettlmtDistrRule {  };
  to_MaintOrdSettlmtDistrRuleHist : Association to many API_MAINTENANCEORDER.MaintOrdSettlmtDistrRuleHist {  };
} actions {
  action ApproveMaintenanceOrder() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action AssignMaintNotificationToOrder(
    @sap.label : 'Notification'
    MaintenanceNotification : String(12),
    @sap.label : 'Header Notif.'
    NotificationIsHeaderNotif : Boolean
  ) returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action RejectMaintenanceOrder() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action ReleaseMaintenanceOrder() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action ResetMaintOrderStatusClosed() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action ResetMaintOrderStsRdyForSchedg() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action ResetMaintOrdOpsStsDispatched() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action ResetMaintOrdStsMainWorkCmplt() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  ...
  action ScheduleMaintenanceOrder() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action SetMaintOrderOpsToDispatched() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  ...
  action SetMaintOrderStatusToLocked() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action SetMaintOrderStatusToUnlocked() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  ...
  action SetMaintOrderToReadyForSchedg() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  ...
  action SubmitMaintOrderForApproval() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
};
...
entity API_MAINTENANCEORDER.MaintenanceOrderLongText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  to_MaintenanceOrder : Association to API_MAINTENANCEORDER.MaintenanceOrder {  };
};
...
entity API_MAINTENANCEORDER.MaintenanceOrderOperation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  @sap.quickinfo : 'Forecasted work (actual + remaining)'
  ...
  @sap.quickinfo : 'Checklists: Checklist type at operation'
  MaintOperationalChecklistType : String(8);
  @sap.label : 'System status'
  @sap.quickinfo : 'System status line'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  UserStatusText : String(40);
  to_MaintenanceOrder : Association to API_MAINTENANCEORDER.MaintenanceOrder {  };
  to_MaintOrderOpComponent : Composition of many API_MAINTENANCEORDER.MaintOrderOpComponent {  };
  to_MaintOrderOpLongText : Composition of many API_MAINTENANCEORDER.MaintOrderOpLongText {  };
  to_MaintOrderOpPhaseControl : Composition of many API_MAINTENANCEORDER.MaintOrderOpPhaseControl {  };
  to_MaintOrderOpProdnRsceTool : Composition of many API_MAINTENANCEORDER.MaintOrderOpProdnRsceTool {  };
  to_MaintOrderOpRelationship : Composition of many API_MAINTENANCEORDER.MaintOrderOpRelationship {  };
} actions {
  action ResetMaintOrderOpStsDispatched() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action SetMaintOrderOpToDispatched() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
};
...
entity API_MAINTENANCEORDER.MaintenanceOrderPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
...
entity API_MAINTENANCEORDER.MaintenanceOrderPhaseControl {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  action ActvtMaintOrderPhaseControl() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action DactvtMaintOrderPhaseControl() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
};
...
entity API_MAINTENANCEORDER.MaintOrderActlPlndCostItmSet {
  @sap.display.format : 'UpperCase'
  ...
  MaintPriority : String(1);
  @sap.display.format : 'NonNegative'
  @sap.label : 'Service Package'
  MMServicePackage : String(10);
  @sap.display.format : 'NonNegative'
  @sap.label : 'Service Package Item'
  MMServicePackageLine : String(10);
  @sap.label : 'Short Text'
  ServiceName : String(40);
  @sap.display.format : 'UpperCase'
  ...
  to_MaintenanceOrder : Association to API_MAINTENANCEORDER.MaintenanceOrder {  };
  to_MaintenanceOrderOpComponent : Association to API_MAINTENANCEORDER.MaintOrderOpComponent {  };
  to_MaintenanceOrderOperation : Association to API_MAINTENANCEORDER.MaintenanceOrderOperation {  };
  @sap.filterable : 'false'
  Parameters : Association to API_MAINTENANCEORDER.MaintOrderActlPlndCostItm {  };
};
...
entity API_MAINTENANCEORDER.MaintOrderActlPlndCostItm {
  @sap.display.format : 'UpperCase'
  ...
  @sap.filterable : 'false'
  key P_GLAccountHierarchy : String(42) not null;
  Set : Association to many API_MAINTENANCEORDER.MaintOrderActlPlndCostItmSet {  };
};
...
entity API_MAINTENANCEORDER.MaintOrderObjectListItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
...
entity API_MAINTENANCEORDER.MaintOrderOpCompLongText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  key MaintenanceOrderComponent : String(4) not null;
  @sap.display.format : 'UpperCase'
  @sap.label : 'Text ID'
  @sap.updatable : 'false'
  key TextObjectType : String(4) not null;
  ...
  to_MaintenanceOrder : Association to API_MAINTENANCEORDER.MaintenanceOrder {  };
  to_MaintenanceOrderComponent : Association to API_MAINTENANCEORDER.MaintOrderOpComponent {  };
};
...
@sap.creatable : 'false'
@sap.content.version : '1'
@sap.label : 'Mainteance Order Component'
entity API_MAINTENANCEORDER.MaintOrderOpComponent {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  MaintOrdOpCompItemCategory : String(1);
  @sap.display.format : 'UpperCase'
  ...
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  MaintOrderComponentInternalID : String(22);
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchase Requisition'
  @sap.quickinfo : 'Purchase Requisition Number'
  PurchaseRequisition : String(10);
  ...
  to_MaintenanceOrderOperation : Association to API_MAINTENANCEORDER.MaintenanceOrderOperation {  };
  to_MaintenanceOrder : Association to API_MAINTENANCEORDER.MaintenanceOrder {  };
  to_MaintOrderOpCompLongText : Composition of many API_MAINTENANCEORDER.MaintOrderOpCompLongText {  };
};
...
entity API_MAINTENANCEORDER.MaintOrderOpLongText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
...
entity API_MAINTENANCEORDER.MaintOrderOpPhaseControl {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  action ActvtMaintOrderOpPhaseControl() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
  action DactvtMaintOrderOpPhaseControl() returns API_MAINTENANCEORDER.DummyFunctionImportResult;
};
...
entity API_MAINTENANCEORDER.MaintOrderOpProdnRsceTool {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
...
entity API_MAINTENANCEORDER.MaintOrderOpRelationship {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
...
entity API_MAINTENANCEORDER.MaintOrderSettlmtDistrRule {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  @sap.creatable : 'false'
  ...
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  SettlementDistributionRuleGrp : String(3);
  @sap.display.format : 'UpperCase'
...
@sap.deletable : 'false'
@sap.content.version : '1'
@sap.label : 'History MaintOrder settlm rules (posted in parallel ledgers)'
entity API_MAINTENANCEORDER.MaintOrdSettlmtDistrRuleHist {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
  @sap.quickinfo : 'Order Number'
  key MaintenanceOrder : String(12) not null;
...
@cds.external : true
type API_MAINTENANCEORDER.DummyFunctionImportResult {
  @sap.label : 'TRUE'
  IsInvalid : Boolean;
};
